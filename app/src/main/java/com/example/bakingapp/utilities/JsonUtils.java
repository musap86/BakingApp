...
public class JsonUtils {
    public static final String BAKE_JSON_STRING = "[\n" +
            "  {\n" +
            "    \"id\": 1,\n" +
            "    \"name\": \"Nutella Pie\",\n" +
            "    \"ingredients\": [\n" +
        ...
        try {
            ...
            if (json instanceof JSONArray) {
                ...
                for (int i = 0; i < array.length(); i++) {
                    ...
                    recipeList.add(jsonObject.optString(NAME));
                }
            }
        } catch (JSONException e) {
            Timber.e("An exception has occurred: %s", e.getMessage());
        }
        return recipeList;
    }
}
